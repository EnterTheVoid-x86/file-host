...
const config: z.input<typeof Schema_Config> = {
  ...
  apiConfig: {
     ...
     */
    rootFolder:
      "55adb1c8bbf675627cb4ec7589aede2ca2b7f5f034b40939d3ab9673ef0c137316711f74a116d6892fbc552d5251c8512b;614fdc1c834369466b25a5f8",
  ...
  siteConfig: {
     ...
     */
    siteName: "Archimax's File Host",
    siteNameTemplate: "%s - %t",
    siteDescription: "File index for various ChromeOS software.",
    siteIcon: "/logo.svg",
    siteAuthor: "Archimax",
    favIcon: "/favicon.png",
    /**
  ...
  {
    "value": "Made with ❤️ by [**{{ author }}**](https://github.com/EnterTheVoid-x86)"
  }
],
    /**
